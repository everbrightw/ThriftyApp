...
class ElecViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getApiCall(url: Constants.zzkIPAddress + "/thrifty/api/v1.0/entity/category/Electronics")
...
extension ElecViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ElecItemCell") as! ElecTableViewCell
