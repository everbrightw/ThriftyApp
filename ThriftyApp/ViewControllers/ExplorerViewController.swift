...
class ExplorerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getApiCall(url: Constants.zzkIPAddress + "/thrifty/api/v1.0/suggestion/" + currentUserId)
...
//
    ...
    extension ExplorerViewController: UITableViewDataSource, UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "ExplorerCell") as! ExploreTableViewCell
