...
class OtherViewController: UIViewController {
      ...
      @IBOutlet var tableView: UITableView!
        ...
        override func viewDidLoad() {
            ...
            getApiCall(url: Constants.zzkIPAddress + "/thrifty/api/v1.0/entity/category/Other")
...
extension OtherViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "OtherItemCell") as! OtherTableViewCell
